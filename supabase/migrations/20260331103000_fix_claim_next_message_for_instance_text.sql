-- ========================================
-- MIGRATION: Corrigir tipo de locked_instance_id no claim por instancia
-- Data: 31/03/2026
-- Proposito: Alinhar a funcao claim_next_message_for_instance ao schema atual
-- ========================================

BEGIN;

DROP FUNCTION IF EXISTS public.claim_next_message_for_instance(text, uuid, text, integer);
